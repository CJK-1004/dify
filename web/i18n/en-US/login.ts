const translation = {
  ...
  welcome: '👋 Welcome to PBT, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting PBT Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on PBT',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on PBT and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The PBT Enterprise license for your workspace has expired. Please contact your administrator to continue using PBT.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect PBT license server. Please contact your administrator to continue using PBT.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The PBT Enterprise license for your workspace is inactive. Please contact your administrator to continue using PBT.',
}
