const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'PBT account',
    langGeniusAccountTip: 'Your PBT account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to PBT to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by PBT allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across PBT\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'PBT {{version}} is now available.',
    latestAvailable: 'PBT {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
