const translation = {
  ...
  feature: {
    ...
    fileUpload: {
      title: '파일 업로드',
      description: '채팅 입력창에서 이미지, 문서 및 기타 파일을 업로드할 수 있습니다.',
    ...
    imageUpload: {
      title: '이미지 업로드',
      description: '이미지 업로드를 허용합니다.',
      supportedTypes: '지원되는 파일 형식',
      numberLimit: '최대 업로드 수',
      modalTitle: '이미지 업로드 설정',
    },
    bar: {
      empty: '웹 앱 사용자 경험을 향상시키려면 기능을 활성화하세요',
      enableText: '활성화된 기능',
      manage: '관리',
    },
    documentUpload: {
      title: '문서',
      description: '문서 기능을 활성화하면 모델이 문서를 받아 관련 질문에 답변할 수 있습니다.',
    },
  },
  codegen: {
    title: '코드 생성기',
    description: '코드 생성기는 구성된 모델을 사용하여 지시사항에 따라 고품질 코드를 생성합니다. 명확하고 상세한 지시사항을 제공해 주세요.',
    instruction: '지시사항',
    instructionPlaceholder: '생성하고자 하는 코드에 대한 상세 설명을 입력하세요.',
    noDataLine1: '왼쪽에 사용 사례를 설명하면,',
    noDataLine2: '여기에 코드 미리보기가 표시됩니다.',
    generate: '생성',
  ...
  generate: {
    title: '프롬프트 생성기',
    description: '프롬프트 생성기는 구성된 모델을 사용하여 더 나은 품질과 구조를 위해 프롬프트를 최적화합니다. 명확하고 상세한 지시사항을 작성해 주세요.',
    tryIt: '시도해보기',
    instruction: '지시사항',
    instructionPlaceHolder: '명확하고 구체적인 지시사항을 작성하세요.',
    generate: '생성',
    resTitle: '생성된 프롬프트',
    noDataLine1: '왼쪽에 사용 사례를 설명하면,',
    noDataLine2: '여기에 오케스트레이션 미리보기가 표시됩니다.',
    apply: '적용',
    loading: '애플리케이션을 오케스트레이션하는 중...',
    overwriteTitle: '기존 구성을 덮어쓰시겠습니까?',
    overwriteMessage: '이 프롬프트를 적용하면 기존 구성을 덮어씁니다.',
    template: {
      pythonDebugger: {
        name: '파이썬 디버거',
        instruction: '지시사항에 따라 코드를 생성하고 디버그할 수 있는 봇',
      },
      translation: {
        name: '번역',
      ...
      professionalAnalyst: {
        name: '전문 분석가',
        instruction: '긴 보고서에서 통찰력을 추출하고 위험을 식별하여 핵심 정보를 단일 메모로 요약',
      },
      excelFormulaExpert: {
        name: '엑셀 수식 전문가',
        instruction: '초보 사용자가 엑셀 수식을 이해하고 사용하며 생성할 수 있도록 도와주는 챗봇',
      },
      travelPlanning: {
        name: '여행 계획',
      ...
      SQLSorcerer: {
        name: 'SQL 마법사',
        instruction: '일상 언어를 SQL 쿼리로 변환',
      },
      GitGud: {
        name: 'Git 마스터',
        instruction: '사용자가 설명한 버전 관리 작업에 따라 적절한 Git 명령어 생성',
      },
      meetingTakeaways: {
        name: '회의 요약',
        instruction: '회의 내용을 토론 주제, 핵심 요점 및 실행 항목을 포함한 간단한 요약으로 정리',
      },
      writingsPolisher: {
        name: '글쓰기 교정기',
        instruction: '고급 교정 기술을 사용하여 글쓰기 개선',
      },
    },
  },
  resetConfig: {
  ...
  variableConfig: {
    ...
    'single-file': '단일 파일',
    'multi-files': '파일 목록',
    'notSet': '설정되지 않음, 접두사 프롬프트에 {{input}}을 입력해보세요',
    'stringTitle': '양식 텍스트 상자 옵션',
    'maxLength': '최대 길이',
    'options': '옵션',
    'addOption': '옵션 추가',
    ...
    'file': {
      ...
      custom: {
        name: '기타 파일 형식',
        description: '기타 파일 형식을 지정하세요.',
        createPlaceholder: '+ 파일 확장자, 예: .doc',
      },
    },
    'uploadFileTypes': '업로드 파일 형식',
    'localUpload': '로컬 업로드',
    'both': '모두',
