const translation = {
  pageTitle: '시작하기 🎉',
//  welcome: 'PBT에 오신 것을 환영합니다. 계속하려면 로그인하세요.',
// [수정] 타이틀 변경
  welcome: 'PBT에 오신 것을 환영합니다. 계속하려면 로그인하세요.',
  email: '이메일 주소',
...
// [수정] 수정
  resetPasswordDesc: 'PBT 가입할 때 사용한 이메일을 입력하면 비밀번호 재설정 이메일을 보내드립니다.', // [수정] 타이틀 변경
  licenseInactiveTip: '작업 영역에 대한 라이선스가 비활성 상태입니다. 계속 사용하려면 관리자에게 문의하십시오.', // [수정] 라이선스 변경
  licenseLost: '라이센스 분실',
  licenseLostTip: '라이선스 서버에 연결하지 못했습니다. 계속 사용하려면 관리자에게 문의하십시오.', // [수정] 라이선스 변경
  licenseInactive: 'License Inactive(라이선스 비활성)',
  licenseExpired: '라이센스가 만료되었습니다.',
  licenseExpiredTip: '작업 영역에 대한 라이선스가 만료되었습니다. 계속 사용하려면 관리자에게 문의하십시오.', // [수정] 라이선스 변경
}
